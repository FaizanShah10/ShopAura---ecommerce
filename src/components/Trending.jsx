...
const Trending = () => {
  return (
    <div className='mt-24 h-auto pb-20'>
        <h1 className='text-center text-3xl font-semibold font-[Gilroy-Medium]'>Trending</h1>
        <p className='text-center font-[Gilroy-Medium]'>Have a Look at what's trending on ShopAura</p>

        <div className=' flex justify-center gap-20 w-full h-[34vw] pt-10'>
            {/* First Div */}
            <div className='w-[20%] h-96 bg-black p-4 rounded-md'>
            ...
            {/* Second Div */}
            <div className='w-[20%] h-[32vw] mt-6 bg-black p-4 rounded-md'>
                <div className='w-full h-[80%] bg-red-300 rounded-md mb-4 overflow-hidden'>
                    <img src={Gymwear} alt="" />
                </div>
            ...
            {/* Third Div */}
            <div className='w-[20%] h-96 mt-20 bg-black p-4 rounded-md relative bottom-0'>
                <div className='w-full h-[80%] bg-red-300 rounded-md mb-4 overflow-hidden'>
